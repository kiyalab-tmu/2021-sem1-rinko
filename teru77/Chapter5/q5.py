...
class LSTM(nn.Module):
    def __init__(self,input_size,output_size):
        super().__init__()
        self.hidden_size = 32
        self.rnn = nn.LSTM(input_size=input_size, hidden_size=self.hidden_size, batch_first=True)
